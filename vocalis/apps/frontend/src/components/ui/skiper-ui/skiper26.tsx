...
export const useThemeToggle = ({
  ...
  }, [setTheme, variant, start, blur, gifUrl, updateStyles, isDark]);
...
export const ThemeToggleButton: React.FC<{
  ...
  return (
    <button
      type="button"
      className={cn(
        'relative inline-flex items-center justify-center cursor-pointer transition-all duration-300 active:scale-95',
        className,
      )}
      onClick={toggleTheme}
      ...
      style={{
        ...
        height: '40px',
        borderRadius: '50%',
        backgroundColor: isDark ? '#1e1e24' : '#000000',
...
export const Skiper26 = ThemeToggleButton;
